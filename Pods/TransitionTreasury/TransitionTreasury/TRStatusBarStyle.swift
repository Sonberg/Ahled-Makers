...
public enum TRStatusBarStyle {
    ...
    static func ConvertToTRStatusBarStyle(_ statusBarStyle: UIStatusBarStyle, statusBarHidden: Bool = UIApplication.shared.isStatusBarHidden) -> TRStatusBarStyle {
    ...
    static func CurrentlyTRStatusBarStyle() -> TRStatusBarStyle {
        return ConvertToTRStatusBarStyle(UIApplication.shared.statusBarStyle)
    }
}
