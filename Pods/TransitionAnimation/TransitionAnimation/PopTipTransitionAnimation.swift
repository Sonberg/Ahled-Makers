...
open class PopTipTransitionAnimation: NSObject, TRViewControllerAnimatedTransitioning {
    ...
    open func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        UIView.animate(withDuration: transitionDuration(using: transitionContext), delay: 0, usingSpringWithDamping: (bounce ? 0.8 : 1), initialSpringVelocity: (bounce ? 0.6 : 1), options: UIViewAnimationOptions(), animations: {
